...
app.post('/admin/addstock', (req, res)=> {
    ...
    const quantity = req.body.quantity;
        ...
        db.execute("INSERT INTO stocks (name,quantity,expiry) VALUES (?,?,?)",
        [name,quantity,expiry]  ,(err,result) => {
...
app.post('/admin/addcompany', (req, res)=> {
 ...
 app.get("/user/vieworders/:username", 
 (req, res) => {
...
app.post('/user/buy', (req,res ) => {
     ...
     db.execute('INSERT INTO orders (cus_name,no_paracetmol,no_ibu,no_dolo,no_pan,no_arip,no_beds,no_oxime) VALUES(?,?,?,?,?,?,?,?)',[username,no_paracetmol,no_ibu,no_dolo,no_pan,no_arip,no_beds,no_oxime], (err,res) => {
         if(err){
             console.log(err);
             return;
    } })
